...
const Contact = () => {
  ...
  return (
    <div className='xl:mt-12 xl:flex-row flex-colireverse flex gap-10 overflow-hidden'>
      ...
      <p className={styles.sectionSubText}>GET IN TOUCH</p>
        ...
        <motion.div variants={slideIn("right","tween",0.2,1)} className="flex-[0.25] flex justify-center items-center">
          <EarthCanvas />
        </motion.div>
      </div>
  )
